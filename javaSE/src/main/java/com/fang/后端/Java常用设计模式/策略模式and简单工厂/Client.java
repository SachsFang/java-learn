...
import com.fang.后端.Java常用设计模式.策略模式and简单工厂.普通用法.ChargeContext;
import com.fang.后端.Java常用设计模式.策略模式and简单工厂.结合枚举用法.ChargeStrategy;
import com.fang.后端.Java常用设计模式.策略模式and简单工厂.结合枚举用法.ChargeStrategyEnum;
